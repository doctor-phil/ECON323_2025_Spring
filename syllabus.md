...
The classes will be held at **LASR 104** from 2:00PM to 3:20PM (Section 002) and in the same room from 5:00pm to 6:30pm (Section 003).
...
In this course, you are permitted the use of AI tools on all assignments, with the exception of exams, and unless otherwise specified. If you use an AI tool for any assignment, you are **required** to provide, at the end of the assignment, a markdown cell that contains a list of:
